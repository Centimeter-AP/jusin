// 20250115.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
    ...
    _In_ int       nCmdShow)           // 창의 스타일(모양 / 최소화 또는 최대한 모양)
{
    ...
    LoadStringW(hInstance, IDC_MY20250115, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY20250115));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY20250115));
