...
enum RENDERID { RENDER_BACKGROUND, RENDER_MAPITEM, RENDER_GAMEOBJECT, RENDER_BEAT, RENDER_EFFECT, RENDER_OBJUI, RENDER_UI, RENDER_LETTERBOX, RENDER_END };
...
enum CHANNELID { SOUND_EFFECT, SOUND_EFFECT2, SOUND_EFFECT3, SOUND_EFFECT4, SOUND_VOCAL, SOUND_BGM, SOUND_BOSS0, SOUND_BOSS1, SOUND_BOSS2, SOUND_BOSS3, SOUND_BOSS4, SOUND_BOSSEFFECT1, SOUND_BOSSEFFECT2, SOUND_BOSSEFFECT3, SOUND_BOSSEFFECT4, SOUND_MERCHANT, SOUND_END };
