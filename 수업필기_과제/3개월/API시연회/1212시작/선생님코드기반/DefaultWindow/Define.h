...
enum OBJID { OBJ_PLAYER, OBJ_BEAT, OBJ_MONSTER, OBJ_ITEM, OBJ_WALL, OBJ_BUTTON, OBJ_EFFECT, OBJ_UI, OBJ_END };

enum RENDERID { RENDER_BACKGROUND, RENDER_MAPITEM, RENDER_GAMEOBJECT, RENDER_BEAT, RENDER_UI, RENDER_EFFECT, RENDER_END };
