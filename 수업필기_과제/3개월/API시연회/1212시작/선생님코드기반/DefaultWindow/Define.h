...
enum OBJID { OBJ_PLAYER, OBJ_BULLET, OBJ_MONSTER, OBJ_ITEM, OBJ_WALL, OBJ_BUTTON, OBJ_END };
...
enum ITEMLIST {ITEM_WEAPON, ITEM_ARMOR, ITEM_SHOVEL, ITEM_HEAL, ITEM_BOMB, ITEM_END};
